...
export const metadata: Metadata = {
  ...
  description:
    "Discover LOTA's professional development programs designed to help young professionals develop leadership skills, expand their networks, and advance their careers.",
}
