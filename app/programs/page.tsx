...
const pageMetadata = {
  ...
  description:
    "Explore our professional development programs including mentorship, leadership workshops, and community engagement initiatives.",
};
...
export default function ProgramsPage() {
  ...
  const categories = [
    "all",
    ...Array.from(
      new Set(communityProjects.map((project) => project.category))
    ),
  ];
  ...
  return (
    <PageTransition>
      ...
      <div id="main-content">
          ...
          <div className="container-wide">
            ...
            <div className="text-center max-w-2xl mx-auto">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Our commitment to excellence and professional development has
                resulted in measurable success across all our programs. We
                continuously evaluate and improve our offerings to ensure
                maximum impact for our members.
              </p>
            </div>
          </div>
        </section>
        ...
        <section
          id="mentorship"
          className="py-24 relative bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900"
        >
          ...
          <div className="container-wide relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="mt-6 space-y-6">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                      Our mentorship program pairs emerging professionals with
                      seasoned industry leaders for personalized guidance and
                      support. Through structured interactions and goal-setting,
                      participants accelerate their professional development and
                  ...
                  <div className="space-y-4 mt-8">
                    <div className="flex items-start bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-200 group">
                      <div
                        className="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center mt-1 shadow-sm"
                        aria-hidden="true"
                      >
                    ...
                    <div className="flex items-start bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-200 group">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-300">
                          Structured approach to defining and achieving your
                    ...
                    <div className="flex items-start bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-200 group">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-300">
                          Expand your professional connections through
                          mentor-facilitated introductions
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              >
                {/* Decorative border */}
                <div
                  className="absolute inset-0 border-2 border-blue-500/20 rounded-2xl z-10 pointer-events-none"
                  aria-hidden="true"
                />
                ...
                <div
                  className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-blue-500/40 rounded-tl-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />
                <div
                  className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-blue-500/40 rounded-tr-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />
                <div
                  className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-blue-500/40 rounded-bl-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />
                <div
                  className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-blue-500/40 rounded-br-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />

                {/* Gradient overlay */}
                <div
                  className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-blue-900/70 to-transparent pointer-events-none"
                  aria-hidden="true"
                />
                ...
                <div className="absolute bottom-0 left-0 w-full p-8">
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 shadow-lg">
                    <blockquote className="text-white">
                      <div
                        className="w-10 h-8 text-blue-300 mb-2"
                        aria-hidden="true"
                      >
                        <svg
                      ...
                      <p className="text-lg font-medium italic">
                        "The mentorship program provided me with invaluable
                        guidance at a critical point in my career."
                      </p>
                      <footer className="mt-4">
                        <div className="flex items-center">
                          <div
                            className="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold"
                            aria-hidden="true"
                          >
                            MZ
                          </div>
        ...
        <section
          id="leadership"
          className="py-24 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 relative"
        >
          ...
          <div className="container-wide relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                {/* Decorative border */}
                <div
                  className="absolute inset-0 border-2 border-indigo-500/20 rounded-2xl z-10 pointer-events-none"
                  aria-hidden="true"
                />
                ...
                {/* Corner decorative elements */}
                <div
                  className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-indigo-500/40 rounded-tl-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />
                <div
                  className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-indigo-500/40 rounded-tr-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />
                <div
                  className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-indigo-500/40 rounded-bl-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />
                <div
                  className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-indigo-500/40 rounded-br-2xl z-20 pointer-events-none"
                  aria-hidden="true"
                />

                <div
                  className="absolute inset-0 bg-gradient-to-r from-indigo-600/30 to-transparent mix-blend-overlay"
                  aria-hidden="true"
                />
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-sm p-2 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors">
                      ...
                      <span className="text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md text-xs">
                        June 15
                      </span>
                    </div>
                    <div className="flex justify-between items-center text-sm p-2 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors">
              ...
              >
                ...
                <div className="mt-6 space-y-6">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
                    <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                      Our workshop series offers practical, hands-on learning
                      experiences focused on developing critical leadership
                      competencies. Led by industry experts, these interactive
                      sessions provide actionable strategies that can be
                  ...
                  <div className="space-y-4 mt-8">
                    <div className="flex items-start bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-200 group">
                      <div
                        className="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center mt-1 shadow-sm"
                        aria-hidden="true"
                      >
                        <span className="text-white text-sm font-bold">1</span>
                      </div>
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-300">
                          Engage in hands-on activities designed to develop
                    ...
                    <div className="flex items-start bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-200 group">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-300">
                          Learn from recognized authorities and seasoned
                    ...
                    <div className="flex items-start bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-200 group">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-gray-600 dark:text-gray-300">
                          Explore a wide range of leadership subjects, from
                          emotional intelligence to strategic planning
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-20 bg-blue-50 dark:bg-blue-950/30 overflow-hidden relative">
          <div className="container-wide">
            ...
            <div className="mt-12 relative" ref={testimonialRef}>
        ...
        <section
          id="community"
          className="py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 relative"
        >
          <div className="absolute inset-0 bg-[url('/images/noise.png')] opacity-[0.02] mix-blend-overlay" />
          <div className="container-wide relative z-10">
            ...
            <div className="mt-16 text-center">
              <div className="inline-block bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-100 dark:border-gray-700">
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Ready to make a difference in your community while developing
                  valuable skills?
                </p>
                <AnimatedButton
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mt-10 pt-10 border-t border-white/10">
                <p className="text-white/70 text-sm">
                  Join our community of leaders and professionals dedicated to
...
const testimonials = [
  {
    ...
    quote:
      "The Leadership Workshop Series transformed my approach to team management. The skills I gained have been instrumental in advancing my career and building a more cohesive team.",
    rating: 5,
  ...
  },
  {
    ...
    quote:
      "Finding a mentor through LOTA's Mentorship Program was a game-changer. My mentor provided invaluable guidance that helped me navigate complex career decisions and develop professionally.",
    rating: 5,
  ...
  },
  {
    ...
    quote:
      "Participating in community engagement projects gave me a new perspective on leadership and teamwork while making a positive impact. It's been incredibly rewarding both personally and professionally.",
    rating: 4,
  ...
  },
  {
    ...
    quote:
      "The quality of networking opportunities and professional connections I've made through LOTA programs has exceeded my expectations. It's opened doors I didn't know existed.",
    rating: 5,
