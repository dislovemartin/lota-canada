      ...
      <div className="container-wide mx-auto py-16">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <ValueCard
              title="Excellence"
              description="We strive for excellence in all our programs, initiatives, and interactions, setting high standards for ourselves and our community."
              index={0}
            />

            <ValueCard
              title="Inclusivity"
              description="We embrace diversity and create an inclusive environment where all perspectives are valued and everyone has the opportunity to contribute and grow."
              index={1}
            />

            <ValueCard
              title="Innovation"
              description="We encourage creative thinking and innovative approaches to leadership challenges, fostering a culture of continuous improvement and adaptation."
              index={2}
            />

            <ValueCard
              title="Integrity"
              description="We act with honesty, transparency, and ethical conduct in all our endeavors, building trust within our community and beyond."
              index={3}
            />

            <ValueCard
              title="Collaboration"
              description="We believe in the power of working together, sharing knowledge, and supporting each other to achieve greater impact and success."
              index={4}
            />

            <ValueCard
              title="Growth"
              description="We are committed to continuous learning and development, both as individuals and as an organization, embracing challenges as opportunities to grow."
              index={5}
            />
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-12 rounded-lg">
          <AnimatedHeading
            title="Our Impact"
            subtitle="Since our founding, LOTA has made a significant impact on the professional community."
            align="center"
            underline
          />
