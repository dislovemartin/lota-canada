    ...
    <>
      ...
      <div className="container-wide mx-auto py-16">
        <div className="max-w-3xl mx-auto">
          <AnimatedHeading
            title="Our Purpose"
            subtitle="The Leaders of Tomorrow Association exists to bridge the gap between emerging talent and established professionals."
            underline
          />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
            <MissionPillar
              ...
              description="We provide structured programs and resources that build essential leadership skills, from communication and decision-making to strategic thinking and emotional intelligence."
              index={0}
            />
            ...
            <MissionPillar
              ...
              description="We facilitate meaningful relationships between emerging leaders and experienced professionals, creating opportunities for guidance, support, and knowledge transfer."
              index={1}
            />
            ...
            <MissionPillar
              ...
              description="We encourage and enable our members to apply their leadership skills to address real-world challenges and make positive contributions to their communities."
              index={2}
            />
            ...
            <MissionPillar
              ...
              description="We foster a culture of continuous improvement, ethical conduct, and high standards, preparing our members to excel in their chosen fields."
              index={3}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <AnimatedHeading
              title="Our Vision"
              subtitle="A future where leadership excellence is accessible to all, and where diverse perspectives drive innovation and positive change."
              underline
            />
        ...
        <div className="bg-black text-white p-12 rounded-lg">
          <div className="max-w-3xl mx-auto text-center">
            <AnimatedHeading
              ...
              subtitle="Become part of a community dedicated to fostering leadership excellence and professional growth."
              align="center"
