...
export const metadata: Metadata = {
  ...
  description:
    "Access resources, articles, and insights from LOTA to support your professional development and leadership journey.",
}
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <ArticleCard
          ...
          description="Learn how emotional intelligence can enhance your leadership effectiveness and team relationships."
          readTime="5 min read"
        ...
        <ArticleCard
          ...
          description="Strategies and insights for making successful career transitions at any stage of your professional journey."
          readTime="8 min read"
        ...
        <ArticleCard
          ...
          description="Practical tips for creating and maintaining a valuable professional network in today's business environment."
          readTime="6 min read"
        ...
        <ArticleCard
          ...
          description="Effective strategies to manage your time and increase productivity in a demanding work environment."
          readTime="7 min read"
        ...
        <ArticleCard
          ...
          title="Mastering Public Speaking and Presentations"
          description="Overcome anxiety and deliver compelling presentations that engage and influence your audience."
        ...
        <ArticleCard
          ...
          description="Strategies for effective leadership during organizational change and uncertain business environments."
          readTime="9 min read"
