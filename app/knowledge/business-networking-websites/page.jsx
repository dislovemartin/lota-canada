    ...
    return (<div className="min-h-screen bg-background">
      ...
      <section className="relative h-[50vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <Image src="/placeholder.svg?height=1080&width=1920" alt="Business networking" fill className="object-cover" priority/>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a href="https://www.bni.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a href="https://www.alignable.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center">
                ...
                <p>
                  ...
                  <a href="https://www.uschamber.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 space-y-8">
                ...
                <div className="bg-primary/10 p-6">
                  ...
                  <Link href="/resources/business-networking-guide.pdf" className="inline-flex items-center px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors text-sm">
                    Download PDF Guide
                  </Link>
                </div>
              </div>
      ...
      <section className="py-16 bg-secondary">
        <div className="container-wide">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/events/networking-workshop" className="inline-flex items-center px-6 py-3 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
