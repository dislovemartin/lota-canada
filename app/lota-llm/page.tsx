...
export default function LOTALLMPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      const url = process.env.NEXT_PUBLIC_LOTA_LLM_SERVER_URL || LOTA_LLM_SERVER_URL;
      setServerUrl(url);
    }
  }, []);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-4">Loading LOTA-LLM Interface...</h1>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
          <h1 className="text-2xl font-bold mb-4">LOTA-LLM Interface is Disabled</h1>
          <p className="mb-4">
            The LOTA-LLM interface is currently disabled. Please enable it by setting the 
            <code className="mx-1 px-2 py-1 bg-gray-100 rounded">NEXT_PUBLIC_ENABLE_LOTA_LLM_CHAT</code>
            environment variable to <code className="mx-1 px-2 py-1 bg-gray-100 rounded">true</code>.
          </p>
          <p>
            You can do this by updating your <code className="mx-1 px-2 py-1 bg-gray-100 rounded">.env.local</code> file.
          </p>
        </div>
      </div>
    );
        ...
        <div className="relative">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h1 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight">
                      LOTA <span className="text-blue-600 dark:text-blue-400">AI</span> Knowledge Base
                    </h1>
                  </div>
                </div>
          ...
          <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <nav className="flex space-x-4 overflow-x-auto scrollbar-hide py-1" aria-label="Tabs">
                <button
                ...
                <button
                  ...
                  title={showIntro ? "Hide introduction" : "Show introduction"}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={showIntro ? "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" : "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"} />
                  </svg>
                </button>
                <button
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <h2 className="text-sm font-medium text-gray-900 dark:text-white">Welcome to LOTA-LLM</h2>
                <p className="text-xs text-gray-600 dark:text-gray-300 mt-0.5">
                  This AI-powered knowledge base allows you to interact with LOTA's documents and resources. 
                  Ask questions in natural language to get instant answers based on our knowledge base.
                </p>
              </div>
              <div className="flex gap-2">
