      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`transition-all duration-200 ${errors.email ? "border-red-500 shadow-sm shadow-red-200" : "border-gray-300 hover:border-gray-400 focus:border-blue-500 dark:border-gray-600 dark:hover:border-gray-500"}`}
              required
            />
            {errors.email && (
        ...
        <div className="text-sm text-gray-600 dark:text-gray-300 p-5 bg-gray-50 dark:bg-gray-800/50 rounded-md border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          <p>
            ...
            <Link href="/privacy-policy" className="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-sm transition-colors duration-200">
              Privacy Policy
            </Link>.
          </p>
        </div>
